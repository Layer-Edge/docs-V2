...
import TopicGrid from '@site/src/components/card';
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('https://dr6rqdr0y14sm.cloudfront.net/images/Verification.png'),
    dark: useBaseUrl('https://dr6rqdr0y14sm.cloudfront.net/images/Verification-dark.png'),
  }}
/>
...
5. **Finalization & Anchoring**  
   The final succinct proof is committed via DA layer + Bitcoin anchoring
...
### 4. Bitcoin Anchoring
- Anchors $\pi_{agg}$ on Bitcoin using:
  - OP_RETURN (hash-only)
  ...
  topics={[
    {
      ...
      description: "Learn more about LayerEdge's Verification Layer",
      link: '/docs/architecture/verification-layer'
    },
    {
      title: 'General Prover / Verifier System',
      description: 'Learn more about General Prover / Verifier System',
      link: '/docs/architecture/general-prover-verifier-system'
    },
    {
      title: 'Data Availability Layer',
      description: "Learn more about how underlying proofs remain publicly verifiable",
      link: '/docs/architecture/data-availability-layer-da-layer'
    },
    {
      title: 'Bitcoin Anchoring',
      description: 'Read more about how the final aggregated proof is anchored on Bitcoin',
      link: '/docs/architecture/bitcoin-anchoring'
    },
    {
      title: 'Built on Babylon',
      description: 'Learn more about how Babylon is integrated with LayerEdge',
      link: '/docs/architecture/built-on-babylon'
    }
  ]}
/>
